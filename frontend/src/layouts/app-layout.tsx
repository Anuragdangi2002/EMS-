...
const nav = [
  {
    ...
    roles: ["ADMIN", "HR", "MANAGER"] as Role[],
  },
  {
    to: "/employees",
    label: "Employees",
  ...
  },
  {
    ...
    label: "Attendance",
    icon: ClipboardCheck,
    roles: ["ADMIN", "HR", "MANAGER", "EMPLOYEE"] as Role[],
  },
  {
    to: "/leaves",
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      >
        <div className="flex h-16 items-center gap-3 border-b border-slate-100 px-6">
          <div className="grid size-8 place-items-center rounded-lg bg-blue-700 font-bold text-white">
            P
          </div>
          <span className="font-bold tracking-tight">PeopleOps</span>
        ...
        <div className="m-3 rounded-xl bg-slate-50 p-3">
          <div className="flex items-center gap-2">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-slate-500">{title(user.role)}</p>
            </div>
          </div>
          <button
            onClick={() => void logout()}
            className="mt-3 flex w-full items-center gap-2 border-t border-slate-200 pt-3 text-xs font-medium text-slate-600 hover:text-red-700"
          >
